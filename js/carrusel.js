(function() {
    ...
    function initCarruseles() {
        ...
        contenedores.forEach(contenedor => {
            ...
            if (contenedor.dataset.carruselInit === 'true') return;
            contenedor.dataset.carruselInit = 'true';

            let posicionActual = 0;

            function actualizarBotones() {
                const w = contenedor.offsetWidth || contenedor.clientWidth;
                const visibleCount = Math.min(4, Math.max(1, Math.floor(w / totalAncho)));
